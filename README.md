...
A chiunque stia studiando **data analysis o data science** e voglia un riferimento pratico da consultare velocemente durante esercizi, progetti o ripasso.

---

## 🛠️ Come sono stati creati

I cheatsheet e gli strumenti sono stati progettati su mie indicazioni personali durante il percorso di studio, con l'aiuto dell'AI come strumento di supporto alla produzione. La struttura, i contenuti e le priorità riflettono le mie esigenze reali di studio — non documentazione generica copiata, ma una selezione ragionata delle cose che uso davvero.

---

## 💡 Come usare l'SQL Execution Explainer

Il file `sql-execution-explainer.html` si apre direttamente nel browser, senza installare nulla:
